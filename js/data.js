...
(function () {
  ...
  const discounts = {
    apex: 80, alpha: 10, lucid: 30, tradeify: 33
  };

  // True Cost to Funding tables: [firmKey, evalCost, activationFee]
  const trueCost = {
    "25K":  [["apex",167,0],["lucid",60,0],["tradeify",175,0]],
    "50K":  [["apex",187,0],["alpha",99,0],["lucid",80,0],["tradeify",250,0]],
    "100K": [["apex",297,0],["alpha",199,0],["lucid",193,0],["tradeify",440,0]],
    "150K": [["apex",397,0],["alpha",239,149],["lucid",259,0],["tradeify",510,0]],
    "250K": [["apex",497,0]],
    "300K": [["apex",597,0]]
  };
  ...
  // Trusted-by strip
  const trustedStrip = ["apex","lucid","tradeify","alpha"];
